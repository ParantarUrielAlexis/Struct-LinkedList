...
const PortalParticles = ({ portalInfo }) => {
  ...
  useEffect(() => {
    if (portalInfo.isVisible) {
      ...
      const initialParticles = Array.from({ length: 30 }, generateParticle);
  ...
  // Update particle physics in animation loop
  useEffect(() => {
    let animationId;
      ...
      if (portalInfo.isVisible) {
        setPortalParticles((prevParticles) => {
          return prevParticles.map((particle) => {
            ...
            if (distance < 5) {
              // Particle reached portal, fade it out
              return { ...particle, life: particle.life - 0.05 };
            }
            ...
            return {
              ...
              x: particle.x + moveX,
              y: particle.y + moveY,
              life: particle.life - 0.003, // Slow fade
            };
